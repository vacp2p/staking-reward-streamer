...
contract XPNFTTokenTest is Test {
    ...
    // string imagePrefix =
    //     'data:image/svg+xml;base64,<svg xmlns="http://www.w3.org/2000/svg" height="200" width="200"><rect
    // width="100%" height="100%" fill="blue"/><text x="50%" y="50%" fill="white" font-size="20" text-anchor="middle">';
