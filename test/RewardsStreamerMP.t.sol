    ...
    function testStake() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                ...
                totalMaxMP: 120e18, // 160e18 - (10e18 * 4) = 120e18
        ...
        checkStreamer(
            CheckStreamerParams({
                totalStaked: 30e18,
                totalMP: 30e18,
                // 225 - 105 from bob who had 120 totalMaxMP MP and had accrued 15
                totalMaxMP: 120e18,
                stakingBalance: 30e18,
...
contract StakeTest is RewardsStreamerMPTest {
    ...
    function test_StakeOneAccountMPIncreasesMaxMPDoesNotChange() public {
        ...
        uint256 totalMaxMP = stakeAmount * streamer.MAX_MULTIPLIER();
    ...
    function test_StakeMultipleAccountsWithMinLockUp() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                ...
                totalMaxMP: sumOfStakeAmount * streamer.MAX_MULTIPLIER() + sumOfExpectedBonusMP,
    ...
    function test_StakeMultipleAccountsMPIncreasesMaxMPDoesNotChange() public {
        ...
        uint256 aliceMaxMP = aliceStakeAmount * streamer.MAX_MULTIPLIER();

        uint256 bobStakeAmount = 5e18;
        uint256 bobMP = bobStakeAmount;
        uint256 bobMaxMP = bobStakeAmount * streamer.MAX_MULTIPLIER();
